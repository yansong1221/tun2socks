...
public:
    ...
    create_proxy_socket(std::shared_ptr<tcp_basic_connection> conn) = 0;
    ...
    virtual void close_endpoint_pair(std::shared_ptr<udp_basic_connection> conn) = 0;
    virtual void close_endpoint_pair(std::shared_ptr<tcp_basic_connection> conn) = 0;
};
}  // namespace tun2socks