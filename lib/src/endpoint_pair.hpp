...
namespace std {
template <>
struct hash<tun2socks::tcp_endpoint_pair>
{
    typedef tun2socks::tcp_endpoint_pair argument_type;
...
template <>
struct hash<tun2socks::udp_endpoint_pair>
{
    typedef tun2socks::udp_endpoint_pair argument_type;
    typedef std::size_t                       result_type;
    inline result_type                        operator()(argument_type const& s) const
    {
        return std::hash<std::string>{}(s.to_string());
