...
public:
    ...
    CharType operator[](size_t pos) const noexcept { return _buffer[pos]; }
    ...
    temporary_buffer share() { return temporary_buffer(_buffer, _size, _deleter.share()); }
    ...
    temporary_buffer clone() const { return {_buffer, _size}; }
    ...
    void trim(size_t pos) noexcept { _size = pos; }
    ...
    deleter release() noexcept { return std::move(_deleter); }
    ...
    static temporary_buffer aligned(size_t alignment, size_t size)
    {
        ...
        ptr = _aligned_malloc(size * sizeof(CharType), alignment);
    ...
    bool operator!=(const temporary_buffer &o) const noexcept { return !(*this == o); }
};
